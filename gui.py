...
def main():
    try:
        ...
        if mode == '1':
            ...
            if not word:
                print("[WARN] No valid word detected from voice. Falling back to text input.")
                word = get_text_input()
        else:
            print("[WARN] Invalid selection. Defaulting to text input.")
            word = get_text_input()
        ...
        try:
            ...
            # dxl_client may not have been initialized if there was an error early on
            pass
